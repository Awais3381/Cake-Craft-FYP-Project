           ...
           child: Column(
             ...
             children: [
               Row(
                 ...
                 children: const [
                   Text('Cake Craft Delivery',style: TextStyle(color: Colors.white,fontSize: 25,fontWeight: FontWeight.bold),),
                 ],
               ),
               const SizedBox(
                 height: 5,
               ),
               const Text('We Deliver Cake at any point of Wapda Town, Lahore and Customize Cake to your according',style: TextStyle(color: Colors.white,fontSize: 14),),
               const SizedBox(
                 height: 40,
               ),
               SizedBox(
