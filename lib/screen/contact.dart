...
import 'package:cakecraft/slider/contactslidder.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          const Icon(Icons.mobile_friendly_rounded,color: Colors.blue,size: 38,),
          const SizedBox(
            height: 10,
          ),
          ...
          const Icon(Icons.lock_clock,color: Colors.blue,size: 40,),
          const SizedBox(
            height: 10,
          ),
