...
import 'package:cakecraft/screen/forgot_password.dart';
import 'package:cakecraft/screen/homepage.dart';
import 'package:cakecraft/screen/signup.dart';
import 'package:cakecraft/screen/test.dart';
            ...
            children: [
             ...
             const Padding(
              ...
              const Padding(
                ...
                child: Text('Back',style: TextStyle(fontSize: 40,fontWeight: FontWeight.bold,color: Colors.white),),
              ),
              Padding(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: TextButton(
                        ...
                        child: const Text('Sign up',style: TextStyle(color: Colors.grey,fontWeight: FontWeight.w500),),),
                    ),
                    const SizedBox(
                      height: 20,
                    ),
  ...
  void signIn(String email, String password) async {
    if (_formkey.currentState!.validate()) {
      await _auth.signInWithEmailAndPassword(email: email, password: password)
        ...
        ScaffoldMessenger.of(context).showSnackBar( const SnackBar( content: Text("Invalid Email/Password",style: TextStyle(color: Colors.white),),backgroundColor: Colors.red, ), );
      }
      );
    }
  }
