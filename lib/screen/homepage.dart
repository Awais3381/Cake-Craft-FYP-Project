import 'dart:io';
import 'package:cakecraft/button/animated_button.dart';
import 'package:cakecraft/helper_widget/custom_card.dart';
import 'package:cakecraft/map/google_map.dart';
import 'package:cakecraft/model/cart_model.dart';
import 'package:cakecraft/model/product_model.dart';
...
import 'package:cakecraft/screen/view_all.dart';
import 'package:cakecraft/slider/slidder.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  List<ProductModel> prDetail2=[
    ...
    ProductModel(id: 4, images: 'images/all/all3.png', name: 'Fresh Cream Cakes'),
                  ...
                  Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Center(child: Text('How would you like to order?',style: TextStyle(color: Colors.blue[400],fontSize: 15),)),
                      ),
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: TextButton.icon(
                            ...
                            label: const Text('Find Location',style: TextStyle(color: Colors.blue,fontSize: 13)),
                          ),
                        )
                      ),
                    ],
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            TextButton(
                              onPressed: (){
                                Navigator.of(context).push(MaterialPageRoute(builder: (context) => const ViewCake()));
                              },
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return CustomCard(
                                ...
                                onTap: (){
                                  ...
                                  Navigator.of(context).push(MaterialPageRoute(builder: (context)=> CakeScreen(temp: '$temp',cartDetail: cartdetail,)));},
                              );
                            },),
                        ),
                      ),
                  ...
                  Center(
                    child: SizedBox(
                      ...
                      child: TextButton(
                        ...
                        onPressed: (){
                          Navigator.of(context).push(MaterialPageRoute(builder: (context) => const CustomCake()));
                        },
                        child: const Text('Customize Cake',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),),
                    ),
                  ),
                  const SizedBox(
                    height: 5,
