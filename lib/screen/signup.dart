...
import 'package:cakecraft/screen/signin.dart';
...
class _SignupState extends State<Signup> {
          ...
          child: Stack(
            children: [
              ...
              const Padding(
                ...
                child: Text('Create',style: TextStyle(fontSize: 40,fontWeight: FontWeight.bold,color: Colors.white),),
              ),
              const Padding(
                padding: EdgeInsets.only(top: 200,left: 20),
                child: Text('Account',style: TextStyle(fontSize: 40,fontWeight: FontWeight.bold,color: Colors.white),),
              ),
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      children: const [
                        Expanded(child:  Divider(thickness: 1,indent: 38,endIndent: 3,)),
                        Text("or",style: TextStyle(color: Colors.grey),),
                        Expanded(child: Divider(thickness: 1,indent: 3,endIndent: 38,))
                      ],
                    ),
                    const SizedBox(
                      height: 8,
                    ...
                    SizedBox(
                      ...
                      child: TextButton(
                        ...
                        child: const Text('Log in',style: TextStyle(color: Colors.grey,fontWeight: FontWeight.w500),),),
                    ),
                    const SizedBox(
                      height: 20,
                    ),
  ...
  postDetailsToFirestore() async{
    ...
    ScaffoldMessenger.of(context).showSnackBar( const SnackBar( content: Text("Registered Successfully",style: TextStyle(color: Colors.white),),backgroundColor: Colors.blue, ) );
  }
}
